...
export const hsnSacCodes: HsnSac[] = [
  { id: 'HSN-2523', code: '2523', description: 'Portland cement, clinkers', gstRate: 28, kind: 'HSN', cgstRate: 14, sgstRate: 14, igstRate: 28, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-7214', code: '7214', description: 'Bars and rods of iron or non-alloy steel', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-2517', code: '2517', description: 'Pebbles, gravel, broken or crushed stone', gstRate: 5, kind: 'HSN', cgstRate: 2.5, sgstRate: 2.5, igstRate: 5, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-2505', code: '2505', description: 'Natural sands of all kinds', gstRate: 5, kind: 'HSN', cgstRate: 2.5, sgstRate: 2.5, igstRate: 5, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-2713', code: '2713', description: 'Petroleum bitumen', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-3824', code: '3824', description: 'Prepared additives for cement and concrete', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-3825', code: '3825', description: 'Ready mix concrete', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-6810', code: '6810', description: 'Articles of cement, concrete or artificial stone', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-4412', code: '4412', description: 'Plywood, veneered panels and similar laminated wood', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-7217', code: '7217', description: 'Wire of iron or non-alloy steel', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-2710', code: '2710', description: 'High speed diesel oil (outside GST — state VAT applies)', gstRate: 0, kind: 'HSN', cgstRate: 0, sgstRate: 0, igstRate: 0, effectiveFrom: '2017-07-01', isNonGst: true, isActive: true },
  { id: 'HSN-7306', code: '7306', description: 'Other tubes and pipes of iron or steel', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-8311', code: '8311', description: 'Coated electrodes for arc welding', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-6506', code: '6506', description: 'Safety headgear', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-6211', code: '6211', description: 'Track suits and other garments — safety jackets', gstRate: 12, kind: 'HSN', cgstRate: 6, sgstRate: 6, igstRate: 12, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-8474', code: '8474', description: 'Machinery for sorting, crushing or mixing mineral substances', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'HSN-2715', code: '2715', description: 'Bituminous mixtures based on natural asphalt', gstRate: 18, kind: 'HSN', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: false },
  { id: 'SAC-9954', code: '995421', description: 'General construction services of highways and roads', gstRate: 18, kind: 'SAC', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'SAC-9973', code: '997313', description: 'Leasing or rental of construction machinery with operator', gstRate: 18, kind: 'SAC', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'SAC-9965', code: '996511', description: 'Road transport services of goods', gstRate: 5, kind: 'SAC', cgstRate: 2.5, sgstRate: 2.5, igstRate: 5, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'SAC-9954B', code: '995431', description: 'Demolition services', gstRate: 18, kind: 'SAC', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
  { id: 'SAC-9983', code: '998341', description: 'Geological and geophysical consulting services', gstRate: 18, kind: 'SAC', cgstRate: 9, sgstRate: 9, igstRate: 18, effectiveFrom: '2017-07-01', isActive: true },
];
...
export const items: Item[] = [
  { id: 'ITM-0001', code: 'CEM-OPC53', name: 'Cement OPC 53 Grade', group: 'CEMENT', specification: 'IS 269:2015, 53 Grade OPC, 50 kg bag', stockUomCode: 'BAG', hsnCode: '2523', gstRate: 28, reorderLevel: 2000,  isActive: true },
  { id: 'ITM-0002', code: 'CEM-PPC', name: 'Cement PPC (Fly Ash Based)', group: 'CEMENT', specification: 'IS 1489 Part 1, PPC, 50 kg bag', stockUomCode: 'BAG', hsnCode: '2523', gstRate: 28, reorderLevel: 1500,  isActive: true },
  { id: 'ITM-0011', code: 'STL-TMT08', name: 'TMT Bar Fe500D 8 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 8 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 8,  isActive: true },
  { id: 'ITM-0012', code: 'STL-TMT10', name: 'TMT Bar Fe500D 10 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 10 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 10,  isActive: true },
  { id: 'ITM-0013', code: 'STL-TMT12', name: 'TMT Bar Fe500D 12 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 12 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 15,  isActive: true },
  { id: 'ITM-0014', code: 'STL-TMT16', name: 'TMT Bar Fe500D 16 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 16 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 15,  isActive: true },
  { id: 'ITM-0015', code: 'STL-TMT20', name: 'TMT Bar Fe500D 20 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 20 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 12,  isActive: true },
  { id: 'ITM-0016', code: 'STL-TMT25', name: 'TMT Bar Fe500D 25 mm', group: 'STEEL', specification: 'IS 1786:2008, Fe500D, 25 mm dia', stockUomCode: 'MT', hsnCode: '7214', gstRate: 18, reorderLevel: 10,  isActive: true },
  { id: 'ITM-0021', code: 'AGG-20MM', name: 'Coarse Aggregate 20 mm', group: 'AGGREGATE', specification: 'Crushed stone aggregate, 20 mm nominal size', stockUomCode: 'CUM', hsnCode: '2517', gstRate: 5, reorderLevel: 250,  isActive: true },
  { id: 'ITM-0022', code: 'AGG-40MM', name: 'Coarse Aggregate 40 mm', group: 'AGGREGATE', specification: 'Crushed stone aggregate, 40 mm nominal size', stockUomCode: 'CUM', hsnCode: '2517', gstRate: 5, reorderLevel: 200,  isActive: true },
  { id: 'ITM-0031', code: 'SND-RIVER', name: 'River Sand', group: 'SAND', specification: 'Zone II natural river sand, screened', stockUomCode: 'CUM', hsnCode: '2505', gstRate: 5, reorderLevel: 150,  isActive: true },
  { id: 'ITM-0032', code: 'SND-MSAND', name: 'M-Sand (Manufactured Sand)', group: 'SAND', specification: 'IS 383 Zone II crushed stone sand', stockUomCode: 'CUM', hsnCode: '2505', gstRate: 5, reorderLevel: 200,  isActive: true },
  { id: 'ITM-0041', code: 'GRN-GSB', name: 'GSB Material (Granular Sub Base)', group: 'GRANULAR', specification: 'MoRTH Table 400-1 Grading II', stockUomCode: 'CUM', hsnCode: '2517', gstRate: 5, reorderLevel: 500,  isActive: true },
  { id: 'ITM-0042', code: 'GRN-WMM', name: 'WMM Material (Wet Mix Macadam)', group: 'GRANULAR', specification: 'MoRTH Clause 406 grading', stockUomCode: 'CUM', hsnCode: '2517', gstRate: 5, reorderLevel: 400,  isActive: true },
  { id: 'ITM-0051', code: 'BIT-VG30', name: 'Bitumen VG-30', group: 'BITUMEN', specification: 'IS 73:2013 Viscosity Grade VG-30', stockUomCode: 'MT', hsnCode: '2713', gstRate: 18, reorderLevel: 25,  isActive: true },
  { id: 'ITM-0052', code: 'BIT-EMUL', name: 'Bitumen Emulsion SS-1', group: 'BITUMEN', specification: 'IS 8887, slow setting emulsion for tack coat', stockUomCode: 'MT', hsnCode: '2713', gstRate: 18, reorderLevel: 10,  isActive: true },
  { id: 'ITM-0061', code: 'RMC-M20', name: 'Ready Mix Concrete M20', group: 'RMC', specification: 'Design mix M20, 20 mm aggregate, 100 mm slump', stockUomCode: 'CUM', hsnCode: '3825', gstRate: 18, reorderLevel: 0,  isActive: true },
  { id: 'ITM-0062', code: 'RMC-M25', name: 'Ready Mix Concrete M25', group: 'RMC', specification: 'Design mix M25, 20 mm aggregate, 100 mm slump', stockUomCode: 'CUM', hsnCode: '3825', gstRate: 18, reorderLevel: 0,  isActive: true },
  { id: 'ITM-0063', code: 'RMC-M30', name: 'Ready Mix Concrete M30', group: 'RMC', specification: 'Design mix M30, 20 mm aggregate, 120 mm slump', stockUomCode: 'CUM', hsnCode: '3825', gstRate: 18, reorderLevel: 0,  isActive: true },
  { id: 'ITM-0071', code: 'MSN-AAC', name: 'AAC Block 600x200x200 mm', group: 'MASONRY', specification: 'IS 2185 Part 3, autoclaved aerated concrete block', stockUomCode: 'NOS', hsnCode: '6810', gstRate: 18, reorderLevel: 3000,  isActive: true },
  { id: 'ITM-0081', code: 'SHT-PLY12', name: 'Shuttering Plywood 12 mm', group: 'SHUTTERING', specification: 'BWP grade film faced plywood 2440x1220x12 mm', stockUomCode: 'NOS', hsnCode: '4412', gstRate: 18, reorderLevel: 100,  isActive: true },
  { id: 'ITM-0091', code: 'CON-BWIRE', name: 'Binding Wire 18 Gauge', group: 'CONSUMABLE', specification: 'MS annealed binding wire, 18 SWG', stockUomCode: 'KG', hsnCode: '7217', gstRate: 18, reorderLevel: 300,  isActive: true },
  { id: 'ITM-0101', code: 'FUL-HSD', name: 'HSD Diesel', group: 'FUEL', specification: 'High speed diesel, BS-VI', stockUomCode: 'LTR', hsnCode: '2710', gstRate: 0, reorderLevel: 5000,  isActive: true },
  { id: 'ITM-0111', code: 'ADM-PCE', name: 'Concrete Admixture (PCE Based)', group: 'ADMIXTURE', specification: 'IS 9103 superplasticiser, polycarboxylate ether', stockUomCode: 'LTR', hsnCode: '3824', gstRate: 18, reorderLevel: 400,  isActive: true },
  { id: 'ITM-0121', code: 'PIP-GI50', name: 'GI Pipe 50 mm B Class', group: 'PIPES_FITTINGS', specification: 'IS 1239 Part 1, galvanised, medium class', stockUomCode: 'RMT', hsnCode: '7306', gstRate: 18, reorderLevel: 200,  isActive: true },
  { id: 'ITM-0131', code: 'ELC-ELEC', name: 'Welding Electrode 3.15 mm', group: 'ELECTRICAL', specification: 'IS 814 E6013, 3.15 mm x 350 mm', stockUomCode: 'KG', hsnCode: '8311', gstRate: 18, reorderLevel: 150,  isActive: true },
  { id: 'ITM-0141', code: 'SAF-HELM', name: 'Safety Helmet', group: 'SAFETY', specification: 'IS 2925, HDPE shell with ratchet harness', stockUomCode: 'NOS', hsnCode: '6506', gstRate: 18, reorderLevel: 100,  isActive: true },
  { id: 'ITM-0142', code: 'SAF-JACK', name: 'Reflective Safety Jacket', group: 'SAFETY', specification: 'Polyester mesh with 2 inch reflective tape', stockUomCode: 'NOS', hsnCode: '6211', gstRate: 12, reorderLevel: 150,  isActive: true },
];
