...
export const terminology = {
  ...
  masters: {
    ...
    itemFull: 'Item & Material Master',
    itemSubtitle: 'Every material, consumable, spare and service that is purchased, stored or issued.',
    itemNew: 'New Item',
    itemEdit: 'Edit Item',
    itemImport: 'Import Items',
    itemEmpty: 'No items defined',
    itemEmptyHint: 'Add an item such as OPC 53 Cement or TMT Bar 12mm to get started.',
    itemDuplicateCode: 'This item code is already in use.',
    ...
    secClassification: 'Type & Behaviour',
    secUnits: 'Units & Conversion',
    secStock: 'Stock Control',
    secCosting: 'Costing Reference',

    itemShortName: 'Short Name',
    itemSubGroup: 'Sub Group',
    itemOldCode: 'Old / Legacy Code',
    itemBrand: 'Preferred Brand',
    itemMakeGrade: 'Make / Grade',
    itemType: 'Item Type',
    itemReturnable: 'Returnable',
    itemProduced: 'Produced In-house',
    itemBatchTracked: 'Batch Tracked',
    itemSerialTracked: 'Serial Numbered',
    itemRequiresQc: 'Requires Inspection',
    itemShelfLife: 'Shelf Life (Days)',
    itemHazardous: 'Hazardous',

    purchaseUom: 'Purchase UOM',
    purchaseFactor: 'Purchase to Stock Factor',
    issueUom: 'Issue UOM',
    issueFactor: 'Issue to Stock Factor',
    factorHint: '1 purchase unit equals how many stock units. 1 BAG = 50 KG.',
    ...
    binLocation: 'Bin / Rack',

    valuationMethod: 'Valuation Method',
    standardRate: 'Standard Rate',
    lastPurchaseRate: 'Last Purchase Rate',
    lastPurchaseDate: 'Last Purchase Date',
    budgetRate: 'Budget Rate Reference',

    typeMATERIAL: 'Material',
    typeCONSUMABLE: 'Consumable',
    typeSPARE: 'Spare Part',
    typeFUEL: 'Fuel & Lubricant',
    typeRETURNABLE: 'Returnable',
    typePRODUCED: 'Produced',
    typeSERVICE: 'Service',
    typeASSET: 'Capital Asset',

    valWEIGHTED_AVERAGE: 'Weighted Average',
    valFIFO: 'FIFO',
    valSTANDARD: 'Standard Rate',

    grpCEMENT: 'Cement',
    grpSTEEL: 'Steel',
    grpAGGREGATE: 'Aggregate',
    grpSAND: 'Sand',
    grpGRANULAR: 'Granular Sub-base',
    grpBITUMEN: 'Bitumen',
    grpRMC: 'Ready Mix Concrete',
    grpMASONRY: 'Masonry',
    grpSHUTTERING: 'Shuttering & Staging',
    grpCONSUMABLE: 'Consumables',
    grpFUEL: 'Fuel',
    grpADMIXTURE: 'Admixtures',
    grpPIPES_FITTINGS: 'Pipes & Fittings',
  ...
  help: {
    ...
    item: 'The master record for anything you buy, store or issue. Every purchase order, receipt and issue line points back to an item here, so the code and unit set here follow the material through the whole system.',
    itemType: 'Decides how the item behaves. Materials and consumables are bought and consumed. Returnable items such as shuttering are expected back. Produced items come out of your own plant. Services are not stocked at all.',
